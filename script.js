...
const IMG = 'image/';
const projects = [
  { id:1,  title:'Masionette',       subtitle:'High end Rental Interface',  category:['Mobile App', 'Web Design'],   tags:['Luxury Booking','Real State', 'Product Design', 'E-Commerce', 'UX Research'], image: IMG+'Masionette.png',  accent:'#0e889b', desc:'A comprehensive luxury stay booking web ecosystem engineered for premium travelers. The platform integrates responsive, high-fidelity property discovery interfaces, real-time pricing dynamic grids, and interactive geographic maps with immersive 3D virtual tour look-ups. It redefines the traditional hospitality funnel by offering guests a completely frictionless, multi-device digital check-in flow and custom concierge service access.', featured:true, url: 'https://www.behance.net/gallery/250569621/Maisonette-Luxury-Estate-Intelligence-Platform/modules/1452830485' },
  { id:2,  title:'Optic to Optic',       subtitle:'See the Difference in Every Detail',     category:'Mobile App',   tags:['Medical & Health-Tech','Medical & Health-Tech-Commerce','Lifestyle & Fashion' , 'Andriod'], image: IMG+'opticToOptic.png',  accent:'#0e889b', desc:'Optic to Optic (O2O Glasses) offers a clean and user-friendly digital eyewear experience that simplifies complex tasks like lens selection and prescription input through a guided flow. Its minimal, premium design builds trust and reduces confusion, making the process intuitive even for first-time users. While the concept is strong and cohesive, adding features like AR try-on and advanced personalization could further enhance usability and engagement. Overall, it presents a well-balanced blend of functionality and modern design.',  url: 'https://www.behance.net/gallery/247042677/Optic-to-Optic/modules/1428413969' },
  { id:3,  title:'Lush Lab',      subtitle:'Where Art meets Beauty',           category:[ 'Landing Page', 'Web Design'], tags:[ 'Beauty' ,'Cosmetics' ,'Wellness','Skincare','Styling'], image: IMG+'Lushlab.png',  accent:'#06B6D4', desc:'LushLab is a sophisticated beauty and wellness platform that merges the precision of design with the elegance of personal aesthetics. The landing page features a seamless appointment booking system for high-end services, including professional makeup artistry, hair styling, and skincare treatments. By focusing on editorial looks and personal transformations, LushLab provides a stunning space where expert techniques and timeless designs create a premium salon experience.', featured:true, url: 'https://www.behance.net/gallery/231727517/Lush-Lab/modules/1329114615' },
  { id:4,  title:'Forge',  subtitle:'Fuel your fitness. Challenge your limits.',     category:'Mobile App',   tags:['Health & Fitness','Data Analytics & Health Tracking' , 'Mobile Wellness Ecosystem','Activity & Goal Monitoring'], image: IMG+'Forge (1).png',  accent:'#10B981', desc:'Forge is a high-energy, data-driven fitness ecosystem designed to help users "Fuel Your Fitness and Challenge Your Limits." The application utilizes a vibrant orange and purple color palette to create a motivating atmosphere, focusing on personalized fitness challenges and gamified progress tracking. As shown in image_8fa880.png, the platform features an intuitive dashboard for weekly reports, caloric data, and activity minutes, alongside a rewards system designed to build consistent workout streaks. With a robust design system built on Poppins typography, Forge provides a professional, seamless interface that transitions from detailed personal data input to interactive, community-driven challenges.',  url: 'https://www.behance.net/gallery/232486595/Forge-fitness-app/modules/1333978473' },
  { id:5,  title:'Freelance Ops',    subtitle:'Operations & Financial Platform',            category:'Mobile App',   tags:['FinTech', 'Mobile','Screens','UI'], image: IMG+'FreelanceOPS.jpg',  accent:'#2cd3bf', desc:'A mobile app that helps freelancers and small business owners manage daily operations, track clients, and analyze financial health.',  url: 'https://www.behance.net/gallery/247053937/Freelance-ops' },
  { id:6,  title:'Dog Walker App',    subtitle:'Huff Snip and Puff Bark',   category:'Mobile App',    tags:['Pet Care','Mobile App','iOS', 'UI/UX'], image: IMG+'Dog Walker App.jpg',  accent:'#730FBF', desc:'Premium pet care management with automated workflows and clear ratings.', url: 'https://www.behance.net/gallery/247459271/Dog-Walker-App' },
  { id:7,  title:'Type Snip', subtitle:'Text Expansion Tool',           category:'Mobile App',  tags:['Productivity',  'App Design', 'Mobile App'], image: IMG+'Typesnip.png',  accent:'#8B5CF6', desc:'Advanced mobile solution featuring automated workflows and custom snippets to speed up daily typing.',  url: 'https://www.behance.net/gallery/246792983/Typesnip' },
  { id:8,  title:'Bhook Stop', subtitle:'Curating your Cravings',       categories:['Landing Page', 'E-Commerce', 'Mobile App' ] , tags:['Food & Drink','On-Demand Services','Productivity & Utility'], image: IMG+'Bhookstop (1).png',  accent:'#F97316', desc:'Bhookstop is a modern, high-tech food platform designed to bridge the gap between hungry users and their favorite meals with a seamless digital experience. As an entry-level UI/UX designer, you are building this to showcase a fast, user-friendly interface that prioritizes visual appeal and functional efficiency.', url: 'https://www.behance.net/gallery/246791095/BhookStop' },
  { id:9,  title:'Zorvix Solutions',    subtitle:'AI Powered FinTech Platform',              category:'Web Design',   tags:['Web Design','FinTech','Landing Page' ,'Saas'], image: IMG+'Zorvex.png',  accent:'#c4b5fd', desc:'A premium corporate landing page redesign focused on redefining modern finance through intelligent, AI-powered corporate tools.',  url: 'https://www.behance.net/gallery/231726411/Zorvex-Solutions' },
  { id:10, title:'Masion',      subtitle:'Art of Interior Design Portal',           category:['Web Design', 'Admin Dashboard'],   tags:['Admin Panel', 'DashBoard' ,'Saas' , 'E-commerce'], image: IMG+'MAsion.png',  accent:'#A855F7', desc:'An elegant administration panel prioritizing clean data grids, client tracking, and minimalist visual layouts tailored for high-end creative businesses.', url: '' },
  { id:11, title:'Shop Smart',     subtitle:'Digital Shopping Exprience',          category:'Web Design',   tags:['E-Commerce', 'Landing Page', 'Web Design'], image: IMG+'Shopsmart.png',  accent:'#ff9900', desc:'A feature-rich retail website interface prioritizing clear promotional banners, localized trending items, and trustworthy social proof layouts.', url: '' },
  ...
  filtered.forEach((p, i) => {
    ...
    card.innerHTML = `
      <div class="project-img-wrap">
        ...
        ${p.year ? `<div class="year-badge" style="background:${p.accent}30;color:${p.accent};border:1px solid ${p.accent}50;">${p.year}</div>` : ''}
      </div>
    ...
    // If a Behance/link URL is provided on the project, make the arrow button open it.
    const arrowEl = card.querySelector('.project-arrow');
    if (p.url && arrowEl) {
      arrowEl.style.cursor = 'pointer';
      arrowEl.setAttribute('tabindex', '0');
      arrowEl.setAttribute('role', 'link');
      arrowEl.addEventListener('click', (e) => { e.stopPropagation(); window.open(p.url, '_blank', 'noopener'); });
      arrowEl.addEventListener('keydown', (e) => {
        if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); window.open(p.url, '_blank', 'noopener'); }
      });
    }
